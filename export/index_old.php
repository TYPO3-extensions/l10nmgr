...
/*	public function catXMLExportAction($l10ncfgObj) {

		global $BACK_PATH, $BE_USER, $MCONF;
	...
	//	$BE_USER->modAccess($MCONF,1);	// This checks permissions and exits if the users has no permission for entry.
		...
		require_once t3lib_extMgm::extPath('mvc').'mvc/class.tx_mvc_backendModuleDispatcher.php';
		require_once t3lib_extMgm::extPath('mvc').'common/class.tx_mvc_common_classloader.php';
		
		tx_mvc_common_classloader::loadAll();
		
		// controller class
		require_once(t3lib_extMgm::extPath('l10nmgr').'controller/class.tx_l10nmgr_controller_xmlexport.php');
		
		$dispatcher = new tx_mvc_backendModuleDispatcher();
		$dispatcher->setExtensionKey('l10nmgr');
		$dispatcher->setModuleKey('txl10nmgrM3_tx_l10nmgr_export');
		$result = $dispatcher->process('xmlexport',false);
...
$_GET['SET']['action'] = $_GET['l10nmgr']['selectedExportFormat'];
$_GET['id'] = $_GET['l10nmgr']['configurationId'];
