...
class tx_l10nmgr_models_translation_testcase extends tx_phpunit_database_testcase {
	 ...
	 * @return void
	 */
	public function test_throwInvalidContentExceptionOnEmptyFile() {
		$pathToFile = t3lib_extMgm::extPath('l10nmgr') . 'tests/translation/fixtures/files/invalidContent/';

		$this->TranslationFactory->create($pathToFile . 'empty.xml');
	}
	 ...
	 * @return void
	 */
	public function test_throwFileNotFoundExceptionOnWrongFilePath() {
		$pathToFile = t3lib_extMgm::extPath('l10nmgr') . 'tests/translation/fixtures/files/';

		$this->TranslationFactory->create($pathToFile . 'noFileHere.xml');
	}
}
