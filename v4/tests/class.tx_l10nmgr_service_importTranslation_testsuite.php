...
/**
 * Static test suite for the "tx_l10nmgr_service_importTranslation"
 *
 * class.tx_l10nmgr_service_importTranslation_testsuite.php
 *
 * {@inheritdoc}
 *
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/l10nmgr/tests/class.tx_l10nmgr_service_importTranslation_testsuite.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/l10nmgr/tests/class.tx_l10nmgr_service_importTranslation_testsuite.php']);
}
