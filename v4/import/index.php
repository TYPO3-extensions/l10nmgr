...
// controller class
require_once(t3lib_extMgm::extPath('l10nmgr').'controller/class.tx_l10nmgr_controller_import.php');

$front = new tx_mvc_backendModuleFrontController();
$front->setExtensionKey('l10nmgr');
$front->setModuleKey('txl10nmgrM3_tx_l10nmgr_import');
$front->process('import');
