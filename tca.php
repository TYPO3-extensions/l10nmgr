...
$TCA["tx_l10nmgr_importdata"] = Array(
	...
	"interface" => Array(
		"showRecordFieldList" => "configuration_id,exportdata_id,force_target_lang,import_as_default_language,import_type,importfiles"
	),
	...
	"columns" => Array(
		...
		"import_type" => Array(
			"exclude" => 1,
			"label" => 'LLL:EXT:l10nmgr/locallang_db.xml:tx_l10nmgr_importdata.import_type',
			"config" => Array(
				"type" => "select",
				"items" => Array(
					Array('XML', 'xml'),
		...
		'import_as_default_language' => array(
			'exclude' => 1,
			'displayCond' => 'HIDE_FOR_NON_ADMINS',
			'label' => 'LLL:EXT:l10nmgr/locallang_db.xml:tx_l10nmgr_importdata.import_as_default_language',
			'config' => array(
				'type' => 'check',
			)
		),
	...
	"palettes" => Array(
		"1" => Array(
			"showitem" => 'force_target_lang,import_as_default_language,import_type',
		)
	)
);
