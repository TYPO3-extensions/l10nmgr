 ...
 */
class tx_l10nmgr_view_export_exporttypes_excelXML extends tx_l10nmgr_view_export_abstractExportView{
		...
		foreach($translateableInformation->getPageGroups() as $pageGroup){
			...
			<Row>
				<Cell ss:Index="2" ss:StyleID="s35"><Data ss:Type="String">'.
					htmlspecialchars($pageGroup->getPageTitle().' [Uid:'.$pageGroup->getUid().']').
				'</Data></Cell>
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/l10nmgr/views/excelXML/class.tx_l10nmgr_view_export_exporttypes_excelXML.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/l10nmgr/views/excelXML/class.tx_l10nmgr_view_export_exporttypes_excelXML.php']);
}
