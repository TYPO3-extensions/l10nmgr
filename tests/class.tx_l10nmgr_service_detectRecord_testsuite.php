...
require_once t3lib_extMgm::extPath('l10nmgr') . 'tests/service/class.tx_l10nmgr_service_detectRecord_basic_testcase.php';
 ...
 * @access public
 */
class tx_l10nmgr_service_detectRecord_testsuite extends tx_phpunit_testsuite {
	...
	public function __construct() {
		...
		$this->setName('Record detection service');

		$this->addTestSuite('tx_l10nmgr_service_detectRecord_basic_testcase');
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/l10nmgr/tests/class.tx_l10nmgr_service_detectRecord_testsuite.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/l10nmgr/tests/class.tx_l10nmgr_service_detectRecord_testsuite.php']);
}
