 ...
 *
 * class.tx_l10nmgr_service_textConverter_testsuite.php
 *
 * {@inheritdoc}
 *
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/l10nmgr/tests/class.tx_l10nmgr_service_textConverter_testsuite.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/l10nmgr/tests/class.tx_l10nmgr_service_textConverter_testsuite.php']);
}
