 ...
 * {@inheritdoc}
 *
 * class.tx_l10nmgr_service_detectRecord_complex_ttcontent_fce_disabledLang_testcase.php
 *
...
class tx_l10nmgr_service_detectRecord_complex_ttcontent_fce_disabledLang_testcase extends tx_l10nmgr_tests_databaseTestcase {
	...
	public function keepIdentityKeyForContentWithNoForcedLanguageUidOnNewElement() {
		...
		$forceTargetLanguageUid   = 2;
		$currentIdentityKey       = 'tt_content:NEW/2/619945:tx_templavoila_flex:data/sDEF/lDEF/field_movie_one_title/vDEF';
		$expectedIdentityKey      = 'tt_content:NEW/' . $forceTargetLanguageUid . '/619945:tx_templavoila_flex:data/sDEF/lDEF/field_movie_one_title/vDEF';
	...
	public function keepIdentityKeyForContentWithNoForcedLanguageUidOnExistingElement() {
		...
		$currentIdentityKey       = 'tt_content:619941:tx_templavoila_flex:data/sDEF/lDEF/field_movie_one_title/vDEF';
	...
	public function buildNewIdentityKeyForContentWithNoForcedLanguageUidOnNotExistingElement() {
		...
		$localisationParentRecord = 619945;
		$forceTargetLanguageUid   = 2;
		$currentIdentityKey       = 'tt_content:12:tx_templavoila_flex:data/sDEF/lDEF/field_movie_one_title/vDEF';
		$expectedIdentityKey      = 'tt_content:NEW/' . $forceTargetLanguageUid . '/619945:tx_templavoila_flex:data/sDEF/lDEF/field_movie_one_title/vDEF';
	...
	public function buildNewIdentityKeyForContentWithNoForcedLanguageUidOnExistingElementWithTheNewIndicator() {
		...
		$localisationParentRecord = 619945;
		$forceTargetLanguageUid   = 3;
		$currentIdentityKey       = 'tt_content:NEW/3/619945:tx_templavoila_flex:data/sDEF/lDEF/field_movie_one_title/vDEF';
		$expectedIdentityKey      = 'tt_content:619941:tx_templavoila_flex:data/sDEF/lDEF/field_movie_one_title/vDEF';
