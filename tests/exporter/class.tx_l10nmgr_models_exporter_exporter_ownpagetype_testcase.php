 ...
 * {@inheritdoc}
 *
 * class.tx_l10nmgr_models_exporter_exporter_ownpagetype_testcase.php
 *
 * @author Timo Schmidt <schmidt@aoemedia.de>
 * @copyright Copyright (c) 2009, AOE media GmbH <dev@aoemedia.de>
 * @license http://www.gnu.org/copyleft/gpl.html GNU General Public License
 * @version $Id: class.tx_l10nmgr_models_exporter_exporter_ownpagetype_testcase.php $
...
class tx_l10nmgr_models_exporter_exporter_ownpagetype_testcase extends tx_phpunit_database_testcase {
	/**
	...
	*/
	public function exportsPagesWithOwnPageType(){
		...
		$exporter 	= new tx_l10nmgr_models_exporter_exporter($exportData,4,$view);
