 ...
 * description
 *
 * class.tx_l10nmgr_domain_translateable_translateableElement.php
 *
 * @author	 Timo Schmidt <schmidt@aoemedia.de>
 * @copyright Copyright (c) 2009, AOE media GmbH <dev@aoemedia.de>
 * @license http://www.gnu.org/copyleft/gpl.html GNU General Public License
 * @version $Id: class.tx_l10nmgr_domain_translateable_translateableElement.php $
...
class tx_l10nmgr_domain_translateable_translateableElement  implements tx_l10nmgr_interface_wordsCountable {
	 ...
	 *
	 * @param tx_l10nmgr_domain_translateable_translateableField $translateableField
	 */
	public function addTranslateableField(tx_l10nmgr_domain_translateable_translateableField $translateableField){
	...
	public function getTranslationUid($languageUid){
		if(is_array($this->translations[$languageUid]) && array_key_exists('uid',$this->translations[$languageUid])){
			return $this->translations[$languageUid]['uid'];
		}else{
			return 0;
		}
	}
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/l10nmgr/domain/translateable/class.tx_l10nmgr_domain_translateable_translateableElement.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/l10nmgr/domain/translateable/class.tx_l10nmgr_domain_translateable_translateableElement.php']);
}
?>