 ...
 *
 * class.tx_l10nmgr_domain_translateable_PageGroup.php
 *
 ...
 * @access public
 */
class tx_l10nmgr_domain_translateable_pageGroup implements tx_l10nmgr_interface_wordsCountable{
	 ...
	 *
	 * @param tx_l10nmgr_domain_translateable_translateableElement
	 */
	public function addTranslateableElement(tx_l10nmgr_domain_translateable_translateableElement $translateableElement){
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/l10nmgr/domain/translateable/class.tx_l10nmgr_domain_translateable_pageGroup.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/l10nmgr/domain/translateable/class.tx_l10nmgr_domain_translateable_pageGroup.php']);
}
?>