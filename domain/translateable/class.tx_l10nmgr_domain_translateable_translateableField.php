 ...
 * description
 *
 * class.tx_l10nmgr_domain_translateable_translateableField.php
 *
 ...
 * @access public
 */
class tx_l10nmgr_domain_translateable_translateableField implements tx_l10nmgr_interface_wordsCountable {
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/l10nmgr/domain/translateable/class.tx_l10nmgr_domain_translateable_translateableField.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/l10nmgr/domain/translateable/class.tx_l10nmgr_domain_translateable_translateableField.php']);
}
