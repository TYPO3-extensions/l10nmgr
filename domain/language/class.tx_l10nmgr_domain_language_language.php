...
class tx_l10nmgr_domain_language_language extends tx_mvc_ddd_typo3_abstractTCAObject {
	...
	public function getStaticLanguage() {
		if (!empty($this->row['static_lang_isocode'])) {
			if (empty($this->row['static_lang_isocode_object'])) {
				$staticLanguageRepository = new tx_l10nmgr_domain_language_staticLanguageRepository();
				$this->row['static_lang_isocode_object'] = $staticLanguageRepository->findById($this->row['static_lang_isocode']);
				if (!$this->row['static_lang_isocode_object'] instanceof tx_l10nmgr_domain_language_staticLanguage) {
