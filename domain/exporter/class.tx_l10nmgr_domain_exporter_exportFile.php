...
class tx_l10nmgr_domain_exporter_exportFile extends tx_mvc_ddd_typo3_abstractTCAObject {
	 ...
	 */
	public function setExportDataObject(tx_l10nmgr_domain_exporter_exportData $exportData) {
