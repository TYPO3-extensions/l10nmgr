...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/l10nmgr/domain/class.tx_l10nmgr_mkPreviewLinkService.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/l10nmgr/domain/class.tx_l10nmgr_mkPreviewLinkService.php']);
}
?>
